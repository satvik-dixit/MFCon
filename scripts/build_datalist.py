...
def findAllSeqs(dirName,
    ...
    """
    dirName_list = ['/ocean/projects/cis220031p/sdixit1/espnet/egs2/voxceleb_full/voxceleb1/dev/wav/'] # , '/ocean/projects/cis220031p/sdixit1/espnet/egs2/voxceleb_full/voxceleb2/dev/audio/'
    global_outSequences = []
    global_outSpeakers = []
    ...
    for dirName in dirName_list:
        ...
        global_outSequences.extend(outSequences)
        global_outSpeakers.extend(outSpeakers)

    return global_outSequences, global_outSpeakers
